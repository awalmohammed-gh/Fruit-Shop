...
const ProductDetails = ({numOfStar = 5}) => {
    ...
    product && (
      <div className="mt-16 px-6 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="mt-24 flex flex-col items-center ">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 md:gap-6 lg:grid-cols-5 gap-y-6 mt-6">
            {relatedProduct
          ...
          <button
            ...
            className="mx-auto cursor-pointer px-12 my-16 py-2.5 border bg-primary rounded text-white hover:bg-primary/10 transition"
          >
            See more
          </button>
        </div>
